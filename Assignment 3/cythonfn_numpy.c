...
#define __PYX_HAVE__cythonfn_numpy
#define __PYX_HAVE_API__cythonfn_numpy
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'cythonfn_numpy' */
...
#define __Pyx_MODULE_NAME "cythonfn_numpy"
extern int __pyx_module_is_main_cythonfn_numpy;
int __pyx_module_is_main_cythonfn_numpy = 0;

/* Implementation of 'cythonfn_numpy' */
...
static const char __pyx_k_cythonfn_numpy[] = "cythonfn_numpy";
...
static const char __pyx_k_cythonfn_numpy_pyx[] = "cythonfn_numpy.pyx";
...
static PyObject *__pyx_n_s_cythonfn_numpy;
static PyObject *__pyx_kp_s_cythonfn_numpy_pyx;
...
static PyObject *__pyx_pf_14cythonfn_numpy_gauss_seidel(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_f); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_14cythonfn_numpy_1gauss_seidel(PyObject *__pyx_self, PyObject *__pyx_arg_f); /*proto*/
static PyMethodDef __pyx_mdef_14cythonfn_numpy_1gauss_seidel = {"gauss_seidel", (PyCFunction)__pyx_pw_14cythonfn_numpy_1gauss_seidel, METH_O, 0};
static PyObject *__pyx_pw_14cythonfn_numpy_1gauss_seidel(PyObject *__pyx_self, PyObject *__pyx_arg_f) {
  __Pyx_memviewslice __pyx_v_f = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("gauss_seidel (wrapper)", 0);
  assert(__pyx_arg_f); {
    __pyx_v_f = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_arg_f, PyBUF_WRITABLE); if (unlikely(!__pyx_v_f.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("cythonfn_numpy.gauss_seidel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14cythonfn_numpy_gauss_seidel(__pyx_self, __pyx_v_f);
...
static PyObject *__pyx_pf_14cythonfn_numpy_gauss_seidel(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_f) {
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_j;
  __Pyx_memviewslice __pyx_v_newf = { 0, 0, { 0 }, { 0 }, { 0 } };
 ...
 */
  __pyx_t_1 = __pyx_memoryview_copy_slice_d_dc_double_c(__pyx_v_f); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_v_newf = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "cythonfn_numpy.pyx":10
 * 	newf = f.copy()
 * 
 * 	for i in range(1,newf.shape[0]-1):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = ((__pyx_v_newf.shape[0]) - 1);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "cythonfn_numpy.pyx":11
 * 
 * 	for i in range(1,newf.shape[0]-1):
 * 		for j in range(1,newf.shape[1]-1):             # <<<<<<<<<<<<<<
 * 			newf[i,j] = 0.25 * (newf[i,j+1] + newf[i,j-1] +
 ...
 */
    __pyx_t_5 = ((__pyx_v_newf.shape[1]) - 1);
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 1; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_j = __pyx_t_7;

      /* "cythonfn_numpy.pyx":12
 * 	for i in range(1,newf.shape[0]-1):
 * 		for j in range(1,newf.shape[1]-1):
 * 			newf[i,j] = 0.25 * (newf[i,j+1] + newf[i,j-1] +             # <<<<<<<<<<<<<<
 * 								   newf[i+1,j] + newf[i-1,j])
 ...
 */
      ...
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_newf.shape[1];
      __pyx_t_10 = __pyx_v_i;
      __pyx_t_11 = (__pyx_v_j - 1);
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_newf.shape[1];

      /* "cythonfn_numpy.pyx":13
 * 		for j in range(1,newf.shape[1]-1):
 * 			newf[i,j] = 0.25 * (newf[i,j+1] + newf[i,j-1] +
 * 								   newf[i+1,j] + newf[i-1,j])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_newf.shape[0];
 ...
 */
      ...
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_newf.shape[0];
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_newf.data + __pyx_t_16 * __pyx_v_newf.strides[0]) ) + __pyx_t_17 * __pyx_v_newf.strides[1]) )) = (0.25 * ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_newf.data + __pyx_t_8 * __pyx_v_newf.strides[0]) ) + __pyx_t_9 * __pyx_v_newf.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_newf.data + __pyx_t_10 * __pyx_v_newf.strides[0]) ) + __pyx_t_11 * __pyx_v_newf.strides[1]) )))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_newf.data + __pyx_t_12 * __pyx_v_newf.strides[0]) ) + __pyx_t_13 * __pyx_v_newf.strides[1]) )))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_newf.data + __pyx_t_14 * __pyx_v_newf.strides[0]) ) + __pyx_t_15 * __pyx_v_newf.strides[1]) )))));
    }
  }

  /* "cythonfn_numpy.pyx":15
 * 								   newf[i+1,j] + newf[i-1,j])
 * 
 * 	return newf             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_18 = __pyx_memoryview_fromslice(__pyx_v_newf, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 15, __pyx_L1_error)
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_newf, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cythonfn_numpy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cythonfn_numpy._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_cythonfn_numpy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cythonfn_numpy},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_cythonfn_numpy, __pyx_k_cythonfn_numpy, sizeof(__pyx_k_cythonfn_numpy), 0, 0, 1, 1},
  {&__pyx_kp_s_cythonfn_numpy_pyx, __pyx_k_cythonfn_numpy_pyx, sizeof(__pyx_k_cythonfn_numpy_pyx), 0, 0, 1, 0},
 ...
 * 	cdef double[:, :] newf
 */
  __pyx_tuple__26 = PyTuple_Pack(5, __pyx_n_s_f, __pyx_n_s_f, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_newf); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(1, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cythonfn_numpy_pyx, __pyx_n_s_gauss_seidel, 5, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 5, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcythonfn_numpy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcythonfn_numpy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cythonfn_numpy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cythonfn_numpy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cythonfn_numpy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cythonfn_numpy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cythonfn_numpy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cythonfn_numpy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cythonfn_numpy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cythonfn_numpy")) {
      if (unlikely(PyDict_SetItemString(modules, "cythonfn_numpy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 	cdef double[:, :] newf
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14cythonfn_numpy_1gauss_seidel, NULL, __pyx_n_s_cythonfn_numpy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gauss_seidel, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cythonfn_numpy.pyx":1
 * #cython: boundscheck=False             # <<<<<<<<<<<<<<
 * # cythonfn_new.pyx
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cythonfn_numpy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cythonfn_numpy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
